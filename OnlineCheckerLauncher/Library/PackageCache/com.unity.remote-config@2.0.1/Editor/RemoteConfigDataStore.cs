...
namespace Unity.RemoteConfig.Editor
{
    public class RemoteConfigDataStore : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        /// <summary>
        /// Declaration of event triggered after action of changed RulesDataStore is performed
        /// </summary>
        ...
        /// <summary>
        /// An integer depicting default rule priority
        /// </summary>
        ...
        /// <summary>
        /// Property with corresponding accessors for list of rules
        /// </summary>
        ...
        /// <summary>
        /// Property with corresponding accessors for last cached list of rules
        /// </summary>
        public JArray lastCachedRulesList { get; set; } = new JArray();

        /// <summary>
        /// Property with corresponding accessors for added rule ids
        /// </summary>
        public List<string> addedRulesIDs { get; set; } = new List<string>();

        /// <summary>
        /// Property with corresponding accessors for updated rule ids
        /// </summary>
        public List<string> updatedRulesIDs { get; set; } = new List<string>();

        /// <summary>
        /// Property with corresponding accessors for deleted rule ids
        /// </summary>
        ...
        /// <summary>
        /// Property for list of rules to be serialized
        /// </summary>
        public string _rulesList;

        /// <summary>
        /// Property for last cached list of rules to be serialized
        /// </summary>
        ...
        /// <summary>
        /// Updates rule with new value
        /// </summary>
        /// <param name="oldRule">old rule </param>
        ...
        /// <summary>
        /// Updates rule id with new id
        /// </summary>
        /// <param name="oldRuleId">old rule id</param>
        /// <param name="newRuleId">new rule id</param>
